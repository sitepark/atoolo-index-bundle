...
class Indexer extends Command
{
    ...
    /**
     * @param \Atoolo\Index\Indexer[] $selectable
     */
    private function selectIndexer(array $selectable): \Atoolo\Index\Indexer
    {
     ...
     */
    private function index(\Atoolo\Index\Indexer $indexer, array $paths): void
    {
        $this->io->newLine();
        $this->io->section(
